// Домашнее задание №1
// Реализация алгоритма поиска с опечатками (расстояние Дамерау-Левенштейна)
// Кафедра «Системы обработки информации и управления», МГТУ им. Н.Э. Баумана
// Автор: Ю.Е. Гапанюк (методические указания), реализация по примеру 16
    ...
    class Program
    {
        static void Main(string[] args)
        {
                        ...
                        while (true)
            {
                ...
                int distance = DamerauLevenshtein(first, second);
                Console.WriteLine($"\"{first}\", \"{second}\" -> {distance}");
                Console.WriteLine();
            }
        }
